...
After making these revisions, I performed another walkthrough with a tester, which I didn't record for privacy reasons but noted her answers and findings. Throughout the test, I showed her my prototype and had her tell me what she would click at each step. To prevent bias, I kept my cursor still until she had told me what to do. I started off by asking general questions about the landing page, regarding what she sees and what the website might be about. For these questions, described my website as a website for a subdivision of the Massachusetts state government which is correct. As for the function, she correctly assumed that the website acted as a resource for financial aid where students and parents can find options relevant to them. This was likely largely influenced by the additional description that I added on the homepage after the in-class walkthrough.

After the introduction, I walked my tester through the two tasks mentioned above, which went very smoothly. Throughout the test, the user was able to correctly identify the buttons that needed to be clicked, and did so with minimal hesitation, which was an indicator of ease of use. This was also great to see considering that I didn't necessarily tell her every single step; sometimes I would say "sort by descending dollar amount," which in itself encompassed a handful of smaller actions. This sureness of her actions remained throughout the test, and she was able to complete both of the tasks I gave her. This was great positive feedback for me, and an indication of the clarity and ease of use of my prototype. From this test alone, there isn't much I would change, but I will be sure to test it with more people who might notice flaws not encountered during this walkthrough.

---

## Reflection

As with every step so far, the hi-fidelity prototyping stage added a lot of value to the process of building my website. It was very rewarding to see all of the feedback I got so far culminate in a prototype that I'm proud of. The cognitive walkthrough was also really informative for me; it indicated that the website overall functions well. Still, one person is by no means a sample from which I can make generalizations, so I will be sure to incorporate more testers as I move closer to my finalized design. Nevertheless, it was useful to learn what works well from a neutral perspective, as it gives me an idea of what I should and shouldn't focus on for future iterations.
